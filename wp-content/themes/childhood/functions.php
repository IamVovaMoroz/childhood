<?php
// 'childhood_scripts' - название функции отслеживает как функции так и скрипты. wp_enqueue_scripts - when scripts start working we run our custom scripts childhood_scripts//
